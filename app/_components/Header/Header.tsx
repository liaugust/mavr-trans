      ...
      <header className="bg-white shadow-[0px_4px_14px_0px_rgba(0,0,0,0.2)]">
        <div className="container">
          <nav className="flex justify-between items-center py-4">
            ...
            <div
              className={`z-40 transition-all flex flex-col lg:flex-row justify-between items-center fixed lg:static left-0 h-full bg-[#121420] lg:bg-white py-20 lg:py-0 ${
                open ? "top-0" : "-top-full"
              }`}
            >
